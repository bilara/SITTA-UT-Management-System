...
const app = createApp({
    data() {
        return {
            ...
            // Reactive state untuk filter, sort, dan tampilkan tabel
            selectedUpbjj: "",
            selectedKategori: "",
            isSafety: false,
            sortBy: "",
    ...
    computed: {
        // untuk memfilter upbjj terlebih dahulu sbelum menampilkan kategori
        kategoriListFiltered() {
            if (!this.selectedUpbjj) return [];
            // ambil kategori unik yang hanya muncul di stok dengan UPBJJ yang dpilih
