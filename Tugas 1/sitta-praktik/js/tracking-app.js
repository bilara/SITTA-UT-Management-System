...
const app = createApp({
    ...
    methods: {
        submitDO() {
            ...
            this.trackingList = {...this.trackingList };
        ...
        hapusDo(key) {
            Swal.fire({
                title: 'Yakin inin menghapus?',
                text: `Do ${key} akan dihapus!`,
                icon: 'warning',
                ...
                if (result.isConfirmed) {
                    delete this.trackingList[key];
                    this.trackingList = { ...this.trackingList };
                    Swal.fire("Terhapus!", "Data Do telah dihapus.", "success");
                }
            });
        }
    },
